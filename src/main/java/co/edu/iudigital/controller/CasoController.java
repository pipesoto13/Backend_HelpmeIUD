...
public class CasoController {
	...
	@ApiOperation(value = "Obtiene todos los casos", response = List.class, produces = "application/json", httpMethod = "GET")
	@GetMapping
	...
	@ApiOperation(value = "Guarda un caso", produces = "application/json", httpMethod = "POST")
	@PostMapping
	public ResponseEntity<CasoDTO> create(@RequestBody CasoDTO casoDTO) {
		try {
			return new ResponseEntity(casoService.save(casoDTO), HttpStatus.CREATED);
		} catch (RestException e) {
